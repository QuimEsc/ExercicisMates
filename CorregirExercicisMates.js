...
/*---------------FI Levenstein distance algorithm---------------------*/
      ...
      if(sessionStorage.getItem("NomAlumnes")==null){ //En cas de no tindre nom d'alumnes.
          var url = 'https://script.google.com/macros/s/AKfycbwUIeYE54QzyN5zmZwebJOJqo2t0fsD7bQZoMM9zo6C7t3u0gW9HopHv27mK9xoMnsI4A/exec?NomAlumne=';  //Crea la url
          var url = encodeURI(url);     //la codifica
          ...
          var url ='https://script.google.com/macros/s/AKfycbwUIeYE54QzyN5zmZwebJOJqo2t0fsD7bQZoMM9zo6C7t3u0gW9HopHv27mK9xoMnsI4A/exec?NomAlumne='+NomAlumne;
          var url = encodeURI(url);     //la codifica
          fetch(url).then(function (response) {
            // The API call was successful!
            return response.json();
  ...
  function ComencaRutina(){
        ...
        var NomAlumne = sessionStorage.getItem("NomAlumnes");   //Carrega dades del SessionStores  -- Nom alumnes
        var Dades = JSON.parse(localStorage.getItem("Dades"));  //Carrega dades del LOCALSTORE
        var Respostes = JSON.parse(localStorage.getItem("Resposta"));   //Carrega tota la info del Magatzem local
        var url = 'https://script.google.com/macros/s/AKfycbwUIeYE54QzyN5zmZwebJOJqo2t0fsD7bQZoMM9zo6C7t3u0gW9HopHv27mK9xoMnsI4A/exec?NomAlumne=' + NomAlumne + '&ID=' + Dades.ID + '&ID_Exercici=' + Dades.ID_Exercici + "&RespostaTeorica="+ Respostes.Resposta + "&Percen=" + Respostes.PercentatgeAcert;  //Crea la url
        var url = encodeURI(url);     //la codifica
