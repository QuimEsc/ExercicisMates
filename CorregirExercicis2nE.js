...
/*---------------FI Levenstein distance algorithm---------------------*/
      ...
      if(sessionStorage.getItem("NomAlumnes")==null){ //En cas de no tindre nom d'alumnes.
          var url = 'https://script.google.com/macros/s/AKfycbztPjI8M7LbhdtE5zcwzBsYiLjRUP71xE5MbDzgFCl___ilA5APHRVaxZYKCozrcJY/exec?NomAlumne=';  //Crea la url
          ...
          var url ='https://script.google.com/macros/s/AKfycbztPjI8M7LbhdtE5zcwzBsYiLjRUP71xE5MbDzgFCl___ilA5APHRVaxZYKCozrcJY/exec?NomAlumne='+NomAlumne;
          var url = encodeURI(url);     //la codifica
          fetch(url).then(function (response) {
            // The API call was successful!
            return response.json();
  ...
  function ComencaRutina(){
        ...
        var url = 'https://script.google.com/macros/s/AKfycbztPjI8M7LbhdtE5zcwzBsYiLjRUP71xE5MbDzgFCl___ilA5APHRVaxZYKCozrcJY/exec?NomAlumne=' + NomAlumne + '&ID=' + Dades.ID + '&ID_Exercici=' + Dades.ID_Exercici + "&RespostaTeorica="+ Respostes.Resposta + "&Percen=" + Respostes.PercentatgeAcert;  //Crea la url
        var url = encodeURI(url);     //la codifica
